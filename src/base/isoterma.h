...
vector<int> calcularRadiosMasCerca(const vector<double>& temps, int cant_r, int cant_a, double isot) {
...
double interpolacionLineal(int radio1, double temp1, int radio2, double temp2, 
...
vector<double> calcularIsotermas(const vector<double>& temps, int cant_r, int cant_a, double isoterma, 
